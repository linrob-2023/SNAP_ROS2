...
#include <stddef.h>
#include "linrob_axis/srv/detail/start_motion__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  linrob_axis__srv__StartMotion_Request__init(message_memory);
}
...
{
  linrob_axis__srv__StartMotion_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember linrob_axis__srv__StartMotion_Request__rosidl_typesupport_introspection_c__StartMotion_Request_message_member_array[3] = {
  {
    ...
    offsetof(linrob_axis__srv__StartMotion_Request, start),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(linrob_axis__srv__StartMotion_Request, target_position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(linrob_axis__srv__StartMotion_Request, velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers linrob_axis__srv__StartMotion_Request__rosidl_typesupport_introspection_c__StartMotion_Request_message_members = {
  ...
  linrob_axis__srv__StartMotion_Request__rosidl_typesupport_introspection_c__StartMotion_Request_message_member_array,  // message members
  linrob_axis__srv__StartMotion_Request__rosidl_typesupport_introspection_c__StartMotion_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  linrob_axis__srv__StartMotion_Request__rosidl_typesupport_introspection_c__StartMotion_Request_fini_function  // function to terminate message instance (will not free memory)
};
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  linrob_axis__srv__StartMotion_Response__init(message_memory);
}
...
{
  linrob_axis__srv__StartMotion_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember linrob_axis__srv__StartMotion_Response__rosidl_typesupport_introspection_c__StartMotion_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(linrob_axis__srv__StartMotion_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(linrob_axis__srv__StartMotion_Response, message),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers linrob_axis__srv__StartMotion_Response__rosidl_typesupport_introspection_c__StartMotion_Response_message_members = {
  ...
  linrob_axis__srv__StartMotion_Response__rosidl_typesupport_introspection_c__StartMotion_Response_message_member_array,  // message members
  linrob_axis__srv__StartMotion_Response__rosidl_typesupport_introspection_c__StartMotion_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  linrob_axis__srv__StartMotion_Response__rosidl_typesupport_introspection_c__StartMotion_Response_fini_function  // function to terminate message instance (will not free memory)
};
...
static rosidl_typesupport_introspection_c__ServiceMembers linrob_axis__srv__detail__start_motion__rosidl_typesupport_introspection_c__StartMotion_service_members = {
  ...
  // linrob_axis__srv__detail__start_motion__rosidl_typesupport_introspection_c__StartMotion_Request_message_type_support_handle,
  NULL  // response message
  // linrob_axis__srv__detail__start_motion__rosidl_typesupport_introspection_c__StartMotion_Response_message_type_support_handle
};
