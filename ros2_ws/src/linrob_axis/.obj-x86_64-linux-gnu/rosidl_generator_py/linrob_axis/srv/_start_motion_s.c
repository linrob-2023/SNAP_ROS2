...
bool linrob_axis__srv__start_motion__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  linrob_axis__srv__StartMotion_Request * ros_message = _ros_message;
  {  // start
...
{
  /* NOTE(esteve): Call constructor of StartMotion_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("linrob_axis.srv._start_motion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StartMotion_Request");
...
bool linrob_axis__srv__start_motion__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  linrob_axis__srv__StartMotion_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of StartMotion_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("linrob_axis.srv._start_motion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StartMotion_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
