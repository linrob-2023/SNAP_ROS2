...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, linrob_axis, srv, StartMotion_Request)() {
  return get_message_type_support_handle<linrob_axis::srv::StartMotion_Request>();
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, linrob_axis, srv, StartMotion_Response)() {
  return get_message_type_support_handle<linrob_axis::srv::StartMotion_Response>();
}
...
{
  return &::linrob_axis::srv::rosidl_typesupport_cpp::StartMotion_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, linrob_axis, srv, StartMotion)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<linrob_axis::srv::StartMotion>();
}
