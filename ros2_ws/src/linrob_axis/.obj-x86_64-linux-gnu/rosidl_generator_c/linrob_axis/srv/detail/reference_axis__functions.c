...
linrob_axis__srv__ReferenceAxis_Request__create()
{
  ...
  memset(msg, 0, sizeof(linrob_axis__srv__ReferenceAxis_Request));
  bool success = linrob_axis__srv__ReferenceAxis_Request__init(msg);
  if (!success) {
...
linrob_axis__srv__ReferenceAxis_Request__destroy(linrob_axis__srv__ReferenceAxis_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    linrob_axis__srv__ReferenceAxis_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
linrob_axis__srv__ReferenceAxis_Request__Sequence__init(linrob_axis__srv__ReferenceAxis_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  linrob_axis__srv__ReferenceAxis_Request * data = NULL;
  ...
  if (size) {
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = linrob_axis__srv__ReferenceAxis_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        linrob_axis__srv__ReferenceAxis_Request__fini(&data[i - 1]);
      }
...
linrob_axis__srv__ReferenceAxis_Request__Sequence__fini(linrob_axis__srv__ReferenceAxis_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      linrob_axis__srv__ReferenceAxis_Request__fini(&array->data[i]);
    }
...
linrob_axis__srv__ReferenceAxis_Request__Sequence__create(size_t size)
{
  ...
  bool success = linrob_axis__srv__ReferenceAxis_Request__Sequence__init(array, size);
  if (!success) {
...
linrob_axis__srv__ReferenceAxis_Request__Sequence__destroy(linrob_axis__srv__ReferenceAxis_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    linrob_axis__srv__ReferenceAxis_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
linrob_axis__srv__ReferenceAxis_Request__Sequence__are_equal(const linrob_axis__srv__ReferenceAxis_Request__Sequence * lhs, const linrob_axis__srv__ReferenceAxis_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!linrob_axis__srv__ReferenceAxis_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  linrob_axis__srv__ReferenceAxis_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(linrob_axis__srv__ReferenceAxis_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    linrob_axis__srv__ReferenceAxis_Request * data =
      (linrob_axis__srv__ReferenceAxis_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!linrob_axis__srv__ReferenceAxis_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          linrob_axis__srv__ReferenceAxis_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!linrob_axis__srv__ReferenceAxis_Request__copy(
...
linrob_axis__srv__ReferenceAxis_Response__init(linrob_axis__srv__ReferenceAxis_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    linrob_axis__srv__ReferenceAxis_Response__fini(msg);
    return false;
  }
  return true;
}
...
linrob_axis__srv__ReferenceAxis_Response__create()
{
  ...
  memset(msg, 0, sizeof(linrob_axis__srv__ReferenceAxis_Response));
  bool success = linrob_axis__srv__ReferenceAxis_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
linrob_axis__srv__ReferenceAxis_Response__Sequence__init(linrob_axis__srv__ReferenceAxis_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  linrob_axis__srv__ReferenceAxis_Response * data = NULL;
  ...
  if (size) {
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = linrob_axis__srv__ReferenceAxis_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        linrob_axis__srv__ReferenceAxis_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
linrob_axis__srv__ReferenceAxis_Response__Sequence__fini(linrob_axis__srv__ReferenceAxis_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      linrob_axis__srv__ReferenceAxis_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
linrob_axis__srv__ReferenceAxis_Response__Sequence__create(size_t size)
{
  ...
  bool success = linrob_axis__srv__ReferenceAxis_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
linrob_axis__srv__ReferenceAxis_Response__Sequence__destroy(linrob_axis__srv__ReferenceAxis_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    linrob_axis__srv__ReferenceAxis_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
linrob_axis__srv__ReferenceAxis_Response__Sequence__are_equal(const linrob_axis__srv__ReferenceAxis_Response__Sequence * lhs, const linrob_axis__srv__ReferenceAxis_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!linrob_axis__srv__ReferenceAxis_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  linrob_axis__srv__ReferenceAxis_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(linrob_axis__srv__ReferenceAxis_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    linrob_axis__srv__ReferenceAxis_Response * data =
      (linrob_axis__srv__ReferenceAxis_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!linrob_axis__srv__ReferenceAxis_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          linrob_axis__srv__ReferenceAxis_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!linrob_axis__srv__ReferenceAxis_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
